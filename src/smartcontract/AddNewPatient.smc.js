...
class AddNewPatient extends BaseSmartContract {

    constructor() {
        super()
        this.creatorKey = 'FF'
        this.contractKey = 'AddNewPatientSmartContract'
    }
    ...
    execute = (creatorKey, contractKey, param) => {
        ...
        if (chainService.addBlockToChain(block)) {
            ...
            const transaction = TransactionModel.init(null, {
                smcKey: 'AddNewPatientSmartContract',
...
export let addNewPatientSmartContract = Object.seal(new AddNewPatient())